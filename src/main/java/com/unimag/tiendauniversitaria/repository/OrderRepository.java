...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("SELECT YEAR(o.createdAt), MONTH(o.createdAt), SUM(o.total), COUNT(o) " +
           "FROM Order o WHERE o.status IN (com.unimag.tiendauniversitaria.enums.OrderStatus.PAID, " +
    ...
    @Query("SELECT o.customer.id, CONCAT(o.customer.firstName, ' ', o.customer.lastName), COUNT(o), SUM(o.total) " +
           "FROM Order o WHERE o.status IN (com.unimag.tiendauniversitaria.enums.OrderStatus.PAID, " +
           "com.unimag.tiendauniversitaria.enums.OrderStatus.SHIPPED, " +
           "com.unimag.tiendauniversitaria.enums.OrderStatus.DELIVERED) " +
           "AND o.createdAt BETWEEN :startDate AND :endDate " +
